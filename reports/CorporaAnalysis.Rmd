...
## Executive Summary
In this document I report the structure and summaries of SwiftKey dataset. I explain and describe the way the dataset must be cleaned. Using tm and other packeges I show features, insights and the most frequent ngrams of the provided dataset.
...
```
"can t", "I m", "I don" and other iterative examinations bring us additional points
- insert "'" where needed
