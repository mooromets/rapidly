...
test_that("ngramTdm() minBound 2", {
  mtx <- as.matrix(ngramTdm(VCorpus(VectorSource("a b c d a b a")),
                            minBound = 2))
  expect_equal(mtx[, 1], c("a" = 3, "b" = 2))
})

test_that("ngramTdm() minBound 4", {
